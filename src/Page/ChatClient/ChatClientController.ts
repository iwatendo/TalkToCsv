...
import ChatClientReceiver from "./ChatClientReceiver";
import ChatClientView from "./ChatClientView";
import ChatClientModel from "./ChatClientModel";
 ...
 * 
 */
export default class ChatClientController extends AbstractServiceController<ChatClientView, ChatClientModel> {
    ...
    public IsEveryTimeScrolling: boolean = false;
